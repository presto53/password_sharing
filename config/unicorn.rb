...
listen '/var/www/pass_sharing/tmp/sockets/unicorn.sock', :backlog => 2048

# By default, the Unicorn logger will write to stderr.
# # Additionally, ome applications/frameworks log to stderr or stdout,
# # so prevent them from going to /dev/null when daemonized here:
stderr_path "/var/www/pass_sharing/log/unicorn.stderr.log"
stdout_path "/var/www/pass_sharing/log/unicorn.stdout.log"
